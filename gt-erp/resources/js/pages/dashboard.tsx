...
import { Calendar, Clock, DollarSign, TrendingDown, TrendingUp, type LucideIcon } from 'lucide-react';
...
// --- Sub-Components ---
const FinancialSummaryCard: FC<{ title: string; value: number; icon: LucideIcon; color: string; children?: ReactNode }> =
